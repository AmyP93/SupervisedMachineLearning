...
## Results & Thoughts
After following the instructions, I find the model produced very low accuracy scores.  The highest score being with the Random Forest Classifier, which only produced a score of 63%. Based on that, I would not find this model to be reliable. We might look at reducing features, and/or trying some other techniques such as ROC curves, KNN, SVM or Lasso.
